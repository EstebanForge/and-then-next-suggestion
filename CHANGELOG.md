...
- **Request Debouncing**: Per-document debounce with cancellation of stale requests. Only the most recent cursor position triggers a completion. Configurable via `andThenNextSuggestion.debounceMs`.
